...
Component({
  ...
  methods: {
    checkedKeyRepeat(e) {
      ...
      if (!1 !== r) throw new Error("keys有重复元素, radio的key属性不能重复：" + r)
    },
    isRepeat(e) {
      let t = {};
      for (let r in e) {
    ...
    init() {
      const e = this.getRelationNodes("../radio/index");
      this.checkedKeyRepeat(e), this.onChangeHandle(e)
    },
    onChangeHandle(e) {
      e.forEach(e => {
        let t = this.properties.current === e.data.key;
        e.setChecked(t, e.data.key)
      })
    },
    onEmitEventHandle(e, t) {
      this.properties.current = t ? e.key : null;
      const r = this.getRelationNodes("../radio/index");
      this.onChangeHandle(r), Object.assign(e, {
